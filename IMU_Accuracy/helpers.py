...
def run_IMU_Accuracy(subject_code, start_time, end_time, time_elevation_starts, trial_name):
    ...
    OMC1 = OMC1 * IMU1_local_misalignment
    OMC2 = OMC2 * IMU2_local_misalignment
    OMC3 = OMC3 * IMU3_local_misalignment
...
def test_run_IMU_accuracy(IMU_input_file_path, OMC_input_file_path, trim_bool, start_time, end_time, sample_rate,
                          IMU1_local_misalignment, IMU2_local_misalignment, IMU3_local_misalignment,
                          trial_name, APDM_template_file, APDM_settings_file, trial_results_dir,
                          time_elevation_starts, subject_code):
