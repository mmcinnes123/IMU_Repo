...
from helpers_calibration import get_IMU_offsets_METHOD_4
...
def run_METHOD_4_cal(subject_code, IMU_type, calibration_name, pose_name1, pose_name2):
...
for calibration_name, pose_names in calibration_name_dict.items():
    ...
    for subject_code in subject_code_list:
        for IMU_type in IMU_type_list:
            ...
            run_METHOD_4_cal(subject_code='P1', IMU_type='Perfect', calibration_name='METHOD_4_Alt_self',
